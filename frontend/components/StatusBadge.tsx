const STATUS_STYLES: Record<string, { badge: string; dot: string }> = {
  ...
  "CONCILIADO (título descontado)": { badge: "bg-teal-50 text-teal-800 border-teal-200", dot: "bg-teal-600" },
  ...
  "TÍTULO DESCONTADO SEM CORRESPONDÊNCIA": { badge: "bg-amber-50 text-amber-800 border-amber-200", dot: "bg-amber-500" },
